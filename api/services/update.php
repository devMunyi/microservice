<?php 
    ...
    //////-----------End of validation
    $updatefds = "company_name=$company_name, service_title='$service_title', service_address='$service_address', next_run_datetime='$next_run_datetime', unit=$unit, frequency=$frequency";
