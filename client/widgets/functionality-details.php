<div class="content-header">
    <?php
    $functionality_ = $_GET['functionality'];
    ?>
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class=""> Functionality
                    <small><span class="func_name active sm"><i>Loading...</i></span></small>
                </h3>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a class="aco text-muted" href="index">Home</a></li>
                    <li class="breadcrumb-item">Functionalities</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <input type="hidden" value="<?php echo $functionality_ ?>" id="functionality_" />
</section>